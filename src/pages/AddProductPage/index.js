                            ...
                            <form>
                                <div className="field">
                                    ...
                                    <div className="field">
                                        ...
                                        <div className="control">
                                            {/* <input className="input is-hovered" type="text" onChange={this.handleInputChange} name="userId" value={this.state.userId} placeholder="use upload component instead" /> */}
