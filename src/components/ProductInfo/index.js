                                ...
                                <div className="field">
                                    ...
                                    <div className="field">
                                        ...
                                        <div className="control">
                                            <input className="input is-hovered" type="text" onChange={handleInputChange} name="name" value={productState.name} placeholder={props.product.name} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="field">
                                        ...
                                        <div className="control">
                                            <input className="input is-hovered" type="text" onChange={handleInputChange} name="description" value={productState.description} placeholder={props.product.description} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="field">
                                        ...
                                        <div className="control">
                                            <input className="input is-hovered" type="text" onChange={handleInputChange} name="price" value={productState.price} placeholder={props.product.price} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="field">
                                        ...
                                        <div className="control">
                                            <input className="input is-hovered" type="text" onChange={handleInputChange} name="details" value={productState.details} placeholder={props.product.details} />
                                        </div>
                                    </div>
                                    <div className="field">
